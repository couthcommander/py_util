...
#put values into dictionary
    ...
    while(len(linecohort) > 1 and len(lineoutcome) > 1):
        if(cohortid > outcomeid):
            ...
            while(cohortid < outcomeid):
                res = calcdata(cdateint, clastenc+args.encgap, [], intervalperiod, maxback, lastback, lastforward)
            ...
            while(cohortid == previd):
                ...
                res = calcdata(cdateint, clastenc+args.encgap, data, intervalperiod, maxback, lastback, lastforward)
